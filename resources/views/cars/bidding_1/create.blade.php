...
<div class="page-wrapper">
    <div class="content">
        ...
        <form method="POST" action="{{ route('bidding.store') }}" class="add-bidding-form" enctype="multipart/form-data">
            @csrf
                        ...
                        <div id="SpacingOne" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body border-top">
                                            ...
                                            <div class="range-container">
                                                <div class="input-row-grid" data-pair-id="0">
                                                    <div class="input-group" style="display: grid">
                                                        <label>From</label>
                                                        <input type="text" name="bid_increment[0][from]" placeholder="Enter From" style="width: 100%;">
                                                    </div>
                                                    <div class="input-group" style="display: grid">
                                                        <label>To</label>
                                                        <input type="text" name="bid_increment[0][to]" placeholder="Enter To" style="width: 100%;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bid-amount">
                                            ...
                                            <div class="amount-container">
                                                <div class="amount-grid">
                                                    ...
                                                    <input type="text" name="bid_increment[0][amount][]" placeholder="Enter Amount">
                                                    <input type="text" name="bid_increment[0][amount][]" placeholder="Enter Amount">
                                                    <input type="text" name="bid_increment[0][amount][]" placeholder="Enter Amount">
                                                    <input type="text" name="bid_increment[0][amount][]" placeholder="Enter Amount">
                                                </div>
                                            </div>
                                            <p class="note">Note: Leave blank for amount if not applicable.<br>Decrease button appears based on visible amounts.</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="timing-grid">
                                        <div>
                                            ...
                                            <div class="input-wrapper">
                                                <input type="text" name="bid_session_duration" placeholder="Enter minutes">
                                ...
                                <div class="section-container">
                                    ...
                                    <div class="countdown-grid" id="countdownGrid">
                                        <div class="countdown-row" data-interval="First">
                                            ...
                                            <div class="input-wrapper">
                                                <input type="text" name="countdown_first_interval" placeholder="Enter seconds">
                                                <span class="unit">seconds</span>
                                            </div>
                                        ...
                                        <div class="countdown-row" data-interval="Second">
                                            ...
                                            <div class="input-wrapper">
                                                <input type="text" name="countdown_second_interval" placeholder="Enter seconds">
                                                <span class="unit">seconds</span>
                                            </div>
                                        ...
                                        <div class="countdown-row" data-interval="Third">
                                            ...
                                            <div class="input-wrapper">
                                                <input type="text" name="countdown_third_interval" placeholder="Enter seconds">
                                                <span class="unit">seconds</span>
                                            </div>
                                ...
                                <div class="section-container">
                                    <div class="two-column-grid">
                                        ...
                                        <div class="column-right">
                                            <h2>Cooling Period for Bid <span class="info-icon"><span class="circle-icon">
                                                        <i class="fa-solid fa-circle" style="color: black;"></i>
                                                        <span class="circle-text">i</span></span></h2>
                                ...
                                <div class="section-container">
                                    <div class="two-column-grid">
                                        ...
                                        <div class="column-right">
                                            ...
                                            <div class="input-wrapper">
                                                <input type="text" name="resbid_price_reduction" placeholder="Enter Value">
                                ...
                                <div class="section-container">
                                    ...
                                    <div id="bid-schedule-container" class="p-2 overflow-auto" style="white-space:nowrap;">
                                        ...
                                        <div>
                                            ...
                                            <div class="input-wrapper" style="width: 200px;">
                                                <select id="carmake" name="carmake[]"
                                                    ...
                                                    data-placeholder="Select Car Make" data-search-url="{{ route('bidding.search') }}" multiple>

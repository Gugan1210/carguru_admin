<?php $page = 'create-country'; ?>
@extends('layouts.app', [
    'activePage' => 'table',
    'title' => 'Create Country - Admin Panel - CarGuru',
    'navName' => 'Table List',
...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4 class="fw-bold">Create Country</h4>
                        <h6>Add a new country</h6>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('country.store') }}" class="add-country-form">
                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="iso2" class="form-control" value="{{ old('iso2') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="iso3" class="form-control" value="{{ old('iso3') }}" required>
                                            </div>
                                        </div>
        ...
        <option value="Norway" {{ old('name') == 'Norway' ? 'selected' : '' }}>Norway</option>
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="phone_code" class="form-control" value="{{ old('phone_code') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="continent" class="form-control" value="{{ old('continent') }}" required>
                                            </div>
                                        </div>

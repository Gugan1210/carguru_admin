@extends('layouts.app', ['activePage' => 'table', 'title' => 'Edit Language - Admin Panel - CarGuru', 'navName' => 'Table List', 'activeButton' => 'laravel'])
@section('content')
            ...
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4 class="fw-bold">Edit Language</h4>
                        <h6>Update language details</h6>
                    </div>
                </div>
                <div class="page-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <select name="country_id" id="country_id" class="form-select" required>
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" {{ $language->country_id == $country->id ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <select name="status" id="status" class="form-select" required>
                                <option value="1" {{ old('status', $language->status) == 1 ? 'selected' : '' }}>Active
                                </option>
                                <option value="0" {{ old('status', $language->status) == 0 ? 'selected' : '' }}>In-Active
                                </option>
                            </select>
                        </div>
                    </div>
